	...
	protected static void checkServerStatus()
	{
		...
		.respond()
				.withBody(
						...
						+ "Below APIs are mocked \n\n Points System API => isProgramEnabled \n "
						+ "Points System API => getRupeetoPointMultiplier \n "
						+ "Points System API => getPointsRedemptionMinThreshold \n "
						+ "Points System API => getAvailablePoints \n "
						+ "Points System API => getPointsExpiryDays \n "
						+ "Auto suggestor System API => getAutoSuggestions \n "
